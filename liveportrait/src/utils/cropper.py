...
class Cropper(object):
    def __init__(self, **kwargs) -> None:
        ...
        self.face_analysis_wrapper = FaceAnalysisDIY(
                    name="buffalo_l",
                    root=self.crop_cfg.root_path + self.crop_cfg.insightface_root,
        ...
        self.human_landmark_runner = HumanLandmark(
            ckpt_path=self.crop_cfg.root_path + self.crop_cfg.landmark_ckpt_path,
        ...
        if self.image_type == "animal_face":
            ...
            self.animal_landmark_runner = AnimalLandmarkRunner(
                    ...
                    model_checkpoint_path=self.crop_cfg.root_path + self.crop_cfg.xpose_ckpt_path,
