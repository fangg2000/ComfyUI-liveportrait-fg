...
class CropConfig(PrintableConfig):
    root_path: str = ""
    insightface_root: str = "/models/liveportrait/insightface"
    landmark_ckpt_path: str = "/models/liveportrait/landmark.onnx"
    ...
    xpose_ckpt_path: str = "/models/liveportrait/animals/xpose.pth"
