...
class InferenceConfig(PrintableConfig):
    ...
    checkpoint_F: str = '/models/liveportrait/base_models/appearance_feature_extractor.pth'  # path to checkpoint of F
    checkpoint_M: str = '/models/liveportrait/base_models/motion_extractor.pth'  # path to checkpoint pf M
    checkpoint_G: str = '/models/liveportrait/base_models/spade_generator.pth'  # path to checkpoint of G
    checkpoint_W: str = '/models/liveportrait/base_models/warping_module.pth'  # path to checkpoint of W
    checkpoint_S: str = '/models/liveportrait/retargeting_models/stitching_retargeting_module.pth'  # path to checkpoint to S and R_eyes, R_lip

    # ANIMAL MODEL CONFIG, NOT EXPORTED PARAMS
    # version_animals = "" # old version
    version_animals = "_v1.1" # new (v1.1) version
    checkpoint_F_animal: str = '/models/liveportrait/animals/base_models/appearance_feature_extractor.pth'  # path to checkpoint of F
    checkpoint_M_animal: str = '/models/liveportrait/animals/base_models/motion_extractor.pth'  # path to checkpoint pf M
    checkpoint_G_animal: str = '/models/liveportrait/animals/base_models/spade_generator.pth'  # path to checkpoint of G
    checkpoint_W_animal: str = '/models/liveportrait/animals/base_models/warping_module.pth'  # path to checkpoint of W
    checkpoint_S_animal: str = '/models/liveportrait/retargeting_models/stitching_retargeting_module.pth'  # path to checkpoint to S and R_eyes, R_lip, NOTE: use human temporarily!
